...
import LocationMap from "../SellerVirtuaTour/LocationMap"; // Import LocationMap component
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "http://localhost:3005/property/createVirtualTour",
        formData,
        {
          headers: {
                          ...
                          <Grid
                            ...
                            sx={{
                              ...
                              "&:hover": {
                                ...
                                boxShadow:
                                  "0px 4px 12px rgba(0, 123, 255, 0.2)", // Add box shadow on hover
                              },
                            }}
                            onClick={() =>
                              document
